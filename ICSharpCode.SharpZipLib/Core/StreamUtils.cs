...
namespace ICSharpCode.SharpZipLib.Core
{
	...
	public sealed class StreamUtils
	{
		...
		{
			if (source == null) {
				throw new ArgumentNullException(ICSharpCode.SharpZipLib.Name.Of(source));
			}

			if (destination == null) {
				throw new ArgumentNullException(ICSharpCode.SharpZipLib.Name.Of(destination));
			}
			...
			if (buffer.Length < 128) {
				throw new ArgumentException("Buffer is too small", ICSharpCode.SharpZipLib.Name.Of(buffer));
			}
			...
			object sender, string name, long fixedTarget)
		{
			...
			if (progressHandler == null) {
				throw new ArgumentNullException(ICSharpCode.SharpZipLib.Name.Of(progressHandler));
			}
