...
namespace ICSharpCode.SharpZipLib.Core
{
	...
	public class ExtendedPathFilter : PathFilter
	{
		...
		public DateTime MinDate {
			...
			set {
				if (value > maxDate_) {
					throw new ArgumentOutOfRangeException(ICSharpCode.SharpZipLib.Name.Of(value), "Exceeds MaxDate");
				}
		...
		public DateTime MaxDate {
			...
			set {
				if (minDate_ > value) {
					throw new ArgumentOutOfRangeException(ICSharpCode.SharpZipLib.Name.Of(value), "Exceeds MinDate");
				}
